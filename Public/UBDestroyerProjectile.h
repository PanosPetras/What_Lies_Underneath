...
#include "UBDestroyerProjectile.generated.h"
...
UCLASS()
class WLU_MP_API AUBDestroyerProjectile : public APawn
{
	GENERATED_BODY()

public:
	// Sets default values for this pawn's properties
	AUBDestroyerProjectile();
...
public:	
	...
	void MulticastRPCFunction_PlayEffects();
};
